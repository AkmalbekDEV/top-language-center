        ...
        <div className='flex items-center justify-between max-sm:flex-col max-sm:gap-10 max-sm:text-center'>
          <div className='grid'>
            <div className='max-sm:flex max-sm:justify-center max-sm:flex-col'>
              ...
              <h1 className='font-medium text-blue-700 text-2xl'>Top Language Center</h1>
            </div>
          </div>
          <div className='grid gap-3'>
            ...
            <nav className='grid gap-5'>
              ...
              <a href="https://www.wbsdev.uz" className='text-lg font-medium text-gray-500'>Developer of the site</a>
            </nav>
          </div>
          {/* <div className='grid gap-3'>
