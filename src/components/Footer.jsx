  ...
  return (
    <div className="border-t-2 pt-14 pb-10 mt-20">
        ...
        <div className="flex items-center justify-between max-sm:flex-col max-sm:gap-10 max-sm:text-center">
            ...
            <div className="max-sm:flex max-sm:justify-center max-sm:flex-col">
              <div className="max-sm:flex max-sm:justify-center">
                <img
                  src={Logo}
                  alt=""
                  className="w-[100px] rounded-[50%] mb-10"
                />
              </div>
              <h1 className="font-medium text-blue-700 text-2xl">
                Top Language Center
              </h1>
            </div>
          </div>
          ...
          <div className="grid gap-3">
            ...
            <nav className="grid gap-5">
              <a
                target="_blank"
                href="https://yandex.uz/maps/org/top_lc/236129718447/?ll=60.613763%2C41.566023&z=20.55"
                className="text-lg font-medium text-gray-500"
              >
                Location
              </a>
              <a
                href="mailto:shakhriyorteacher@gmail.com"
                className="text-lg font-medium text-gray-500"
              >
                Email address
              </a>
              <a
                href="tel:+998-91-999-11-29"
                className="text-lg font-medium text-gray-500"
              >
                Mobile number
              </a>
      ...
      <div className="grid gap-5 items-center justify-center mt-10">
        <h1 className="text-center font-medium text-gray-500 text-lg">
